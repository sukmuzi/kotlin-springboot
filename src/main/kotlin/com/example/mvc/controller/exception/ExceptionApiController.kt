...
import com.example.mvc.controller.model.http.Error
...
class ExceptionApiController {
    ...
    // 특정 필드에 대한 검증 실패 시 발생하는 Handler
    ...
    @PostMapping("")
    fun post(@Valid @RequestBody userRequest: UserRequest, bindingResult: BindingResult): UserRequest {
        println(userRequest)
